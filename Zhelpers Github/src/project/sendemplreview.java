...
/**
 * Servlet implementation class sendemplreview
 */
@WebServlet("/sendemplreview")
public class sendemplreview extends HttpServlet {
	private static final long serialVersionUID = 1L;
@Override
	protected void service(HttpServletRequest arg0, HttpServletResponse arg1) throws ServletException, IOException {
	try{String eid= arg0.getParameter("eid");
	String wid= arg0.getParameter("wid");
	String wtype= arg0.getParameter("wtype");
	HttpSession ses= arg0.getSession();
	ses.setAttribute("wid", wid);
	ses.setAttribute("eid", eid);
	ses.setAttribute("wtype",  wtype);
	...
	//out.println("<script type=\'text/javascript\'>");
	 ...
	 //  out.println("</script>");
	   arg1.sendRedirect("emplr_doreview.jsp");
