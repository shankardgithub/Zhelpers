...
<ul style="font-size: 1.3vw;">
  ...
  <li style="float: right;" title='Profile' class="active"><a href="userprofile.jsp"><i class="material-icons">person_outline</i></a></li>
...
<div class="row" >
<%
	sql="select * from userdetails where mobilenumber="+n;
